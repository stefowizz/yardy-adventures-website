...
<head>
    ...
    <meta property="og:image" content="<?php echo $base_url?>/assets/images/frontend/adventure/Yardy%20Rush.jpg">
        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-menu mx-auto ps-lg-4 ps-0">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo $base_url?>/" class="nav-link " aria-current="page">Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo $base_url?>/adventures" class="nav-link " aria-current="page">Adventures</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo $base_url?>/reseller" class="nav-link " aria-current="page">Independent Sellers</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo $base_url?>/about" class="nav-link " aria-current="page">About Yardy</a>
                        </li>

                        <li class="nav-item">
                            <a href="<?php echo $base_url?>/contact" class="nav-link " aria-current="page">Contact Us</a>
                        </li>
                                   </ul>
