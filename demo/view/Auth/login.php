                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10 col-md-10 col-12 main">
                        ...
                        <div class="account-form">
                            ...
                            <form method="POST" class="verify-gcaptcha" id="login">
                                <input type="hidden" name="_token" value="9pshXnIRCbgLNpldjneJ0czchLJgFsqPMjR2S5p8" autocomplete="off">                                <div class="row gy-3">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="username" class="form--label">Username or Email</label>
                                            <input type="text" class="form--control" id="username" name="username" value="" placeholder="User Name  Or Email" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn--base w-100" id="recaptcha">Sign In</button>
                                    </div>
                                    
                                    
                                    <div class="col-12">
                                        <hr class="hr" data-content="OR   RESELLER SIGNUP HERE">
                                    </div>
    ...
    <script> 
        $(document).ready(function () { 
            $('#login').submit(function (e) { 
                ...
                $.ajax({ 
                    url: 'index.php?route=auth/processLogin', 
                    type: 'POST', 
                    data: formData, 
