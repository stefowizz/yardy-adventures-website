...
<head>
    ...
    <title> Yardy Adventures - Sign Up</title>
    <meta name="title" Content="Yardy Adventures - Sign Up">
    ...
    <meta name="apple-mobile-web-app-title" content="Yardy Adventures - Sign Up">
    
    <meta itemprop="name" content="Yardy Adventures - Sign Up">
    ...
    <meta property="og:url" content="https://yardyadventures.com/demo/influencer/register">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10 col-md-10 col-12 main">
                        ...
                        <div class="account-form">
                            <div>
                                <h3>Affliate Register!</h3>
                            </div>
                            <form method="POST" class="verify-gcaptcha" id="register">
                                <input type="hidden" name="_token" value="BWxp5Pjy3Axn2Hz5gRndQkP8ZHtqd3dVuPWwOjBT" autocomplete="off">                                
                                <div class="row gy-3">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            <label for="fname" class="form--label">First Name</label>
                                            <input type="text" class="form--control checkUser" id="fname" name="Inputfname" value="" placeholder="First Name" required>
                                            <small class="text-danger fnameExist"></small>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            <label for="lname" class="form--label">Last Name</label>
                                            <input type="text" class="form--control checkUser" id="lname" name="Inputlname" value="" placeholder="Last Name" required>
                                            <small class="text-danger lnameExist"></small>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            <label for="name" class="form--label">Username</label>
                                            <input type="text" class="form--control checkUser" id="username" name="InputUsername" value="" placeholder="Username" required>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form--control checkUser" id="email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" name="InputEmail" value="" placeholder="youremail@example.com" required>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                <input type="number" name="InputPhone" value="" placeholder="1-876-123-4567" class="form-control form--control checkUser" required>
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input id="password" type="password" class="form-control form--control form--password" name="InputPassword" placeholder="Password" required>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input id="confirm-password" type="password" class="form-control form--control form--password" name="InputConfirmPassword" placeholder="Confirm Password" required>
                                            <div class="password-show-hide toggle-password-change fas fa-eye-slash"
                                    ...
                                    <div class="col-sm-12 my-2">
                                        <div class="form--check">
                                            ...
                                            <label for="agree">
                                                I agree with <a href="https://yardyadventures.com/demo/policy/privacy-policy/42" class="text--base">Privacy Policy</a>, <a href="https://yardyadventures.com/demo/policy/terms-of-service/43" class="text--base">Terms of Service</a>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn--base w-100" id="recaptcha">Sign Up</button>
                                    </div>
                                    <div class="col-12">
                                   ...
                                   <!-- <div class="col-12">
                                        <div class="social">
                                            <a href="https://yardyadventures.com/demo/influencer/social/login/google" class="icon" target="_blank">
                                                <i class="fa-brands fa-google"></i>
                                            </a>
                                            <a href="https://yardyadventures.com/demo/influencer/social/login/facebook" class="icon" target="_blank">
                                    ...
                                    <div class="col-12">
                                        <div class="text-center">
                                            <p class="text">Already Have An Account? <a href="https://yardyadventures.com/demo/login"
                                                class="text--base">Login Now</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="existModalLongTitle"><span id="message">You are Registered</span></h5>
        <span type="button" class="close btn--base btn--danger btn--sm" data-bs-dismiss="modal" aria-label="Close">
            <i class="las la-times"></i>
        </span>
      </div>
      <div class="modal-body">
        <h6 class="text-center">You will be directed to you dashboard </h6>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn--base btn--danger btn--sm" data-bs-dismiss="modal">Close</button>
        <a href="https://yardyadventures.com/demo/login" class="btn--base btn-sm">Login</a>
      </div>
    </div>
  </div>
</div>
...
<script src="https://yardyadventures.com/demo/assets/presets/default/js/main.js"></script>
      ...
      "use strict";
        (function ($) {
                        $(`option[data-code=JM]`).attr('selected','');
            ...
            $('.checkUser').on('focusout',function(e){
                var url = 'https://yardyadventures.com/demo/influencer/check-mail';
                var value = $(this).val();
                var token = 'BWxp5Pjy3Axn2Hz5gRndQkP8ZHtqd3dVuPWwOjBT';
            ...
            $('#register').submit(function (e) { 
                ...
                $.ajax({ 
                    ...
                    success: function (response) { 
                        ...
                        $("#existModalCenter").css("display","block");
                        setTimeout(() => {
